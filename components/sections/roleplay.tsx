...
const referenceLogs: ReferenceLog[] = [
  ...
  {
    id: 2,
    url: "https://tldv.io/app/meetings/69ce370f98acd80013fa7459/",
    title: "代理店内部MTG：トップ代理店からの運用フィードバック × クローザー自己成長",
    tags: ["代理店内部", "クローザー自己成長", "AIプロンプト活用", "紹介依頼トーク", "信頼関係設計", "契約後伴奏期間", "代理店制度", "保険代理店戦略"],
    highlight: [
      "クローザー自己成長プロンプト：『キーエンス・プルデンシャル級の営業コーチを毎日装着する』即コピー可能なAI活用法",
      "佐藤代表が同席しないクロージングで信頼関係を崩さないための代替体制設計（代理店クローザー必読）",
      "紹介依頼を確実に取る『3年後フレーム』— AI先行組と脱落組の対比で友人経営者を救う動機を作る話法",
      "業界対立の回避：保険代理店を否定せず『本業＋追加価値』として研修を提案する非対立トーク",
    ],
    watchPoints: [
      "06:03 ★自己成長プロンプトの設計思想「キーエンスとかプルデンシャルの超優秀な営業マンが、僕の担当として付いている体で1日の振り返りを行ってください」（即コピー可能）",
      "06:32 ◆毎日のセルフチェック項目「あなたはクロージングしましたか、LINE交換していませんね、写真を撮っていませんね」（音声入力＋AI自動FBの実装例）",
      "21:41 ★クローザー自己診断「佐藤さんが喋ってくれるだろうと思ってクロージングしてしまっている代理店が多い」（信頼関係の最大の落とし穴）",
      "23:21 ◆代替体制の伝え方「佐藤が入らないけど同等のお話をしてくれる方をちゃんと用意している、安心してください」（顧客への約束のフォーマット）",
      "25:09 ◆温度感の落とし穴「契約から開始まで1.5ヶ月のラグ、待ったら負け」（顧客のテンションを冷まさないクローザーの腕の見せ所）",
      "26:33 ◆ラグ期間の埋め方「研修動画ステップ配信＋チャットボットで毎日コーチング・ヒアリングをプッシュ型で」（提示できる「ここまで考えてます」材料）",
      "27:47 ★角度上げの本質「『最初いきなり動画ですよ』だと冷める、『ここまで考えてくれている』に変えれば紹介依頼が即取れる」（同じ事実の見せ方）",
      "28:13 ★紹介依頼の鉄板「3年後考えてみてください、AI先に入った企業は生き残っている、残り死んでます。早く動いたから生き残れた側に、友達の経営者になれたら信頼関係エグくないですか」",
      "30:43 ◆成果期間トーク「習慣化に最低1ヶ月、3ヶ月にしているのは100日で習慣化が確定するから」（顧客への成果イメージのロジック化）",
      "32:00 ◆裏側の信頼補強「研修中の画面オフの人にプレッシャーをかけるタイミングまで心理学で設計」（サービスの背景を語る信頼ブースター）",
      "36:38 ◆制度設計の応答「UBM代理店じゃないと入れないクローズ設計で、お客さんとの取り合いを防ぐ」（顧客が『自分で代理店やりたい』と言った時の応答）",
      "44:08 ★非対立の取り込み「保険対災害禁止で対立しちゃうけど、保険本業を頑張りつつこの研修もつなげる、で中小企業を助けましょう」（業界対立を仲間化に変える話法）",
      "46:08 ◆強い提案の渡し方「僕は空想で喋るタイプなんで、責任がないからこそ妄想に特化できる、一つの参考にしてもらえたら」（強い意見を謙虚に渡すフレーム）",
    ],
  ...
  {
    id: 8,
    url: "https://tldv.io/app/meetings/69c08d13407aa00013eb50e5/",
    title: "★クローザー向けマスター解説：動線設計→クロージング→入金確認までの全体マニュアル",
    tags: ["クローザー向け説明会", "マスター教材", "営業動線設計", "5大不安への対応", "3日以内特典", "差別化決め台詞", "雇用保険ヒアリング", "入金確認まで"],
    highlight: [
      "★最重要ログ：実商談（ログ①〜⑦）の『種明かし』。動線・トーク・クロージング・差別化フレーズの全マニュアルがここに集約",
      "顧客動線の設計：商品紹介動画→FAQ動画→ヒアリングシステム→AI自動提案書で『結論あなたの会社では効果出ます』状態を作ってからクロージング開始",
      "「カリプローズを取った状態」設計：「この条件で解決するならやっていただけますか？」を先に取って「うん、やります」を引き出す",
      "「明日、スマホ持ってない人と仕事できますか？」最強のクロージング問いかけ — 顧客にAI導入の必要性を一発でイメージさせる",
    ],
    watchPoints: [
      "00:18 ◆動線の前提整理「紹介→節税か事例の2切り口、事務局で受けて最適クローザーをアサイン」（顧客の入り口を完全把握）",
      "00:45 ★節税フックの基本トーク「究極の節税商品、一括損金、75%助成金、お金余ってるならやらないリスクなし、しかも2-6倍生産性UP、しかもプラス」（フックトーク完成型）",
      "03:00 ★動線の核「専門性を極力排除した構成。商品紹介動画→FAQ動画→ヒアリングシステム→AI自動提案書→『結論あなたの会社では効果出ます』→『質問は？』からクロージング」",
      "04:29 ◆ゴール定義「商談・契約・入金・回収までが営業マンの責任、入金確認まで必ずサポート」（クローザーの責任範囲を明示）",
      "05:12 ★カリプローズの取り方「『こういう課題に対してこの条件で解決するならやっていただけますか？』を先に取って『うん、やります』を引き出す」（提案技法の核）",
      "05:38 ◆ヒアリングシート即判定「『これとこれで困ってます』に対し『これできます、これできます、これできません』で即判定→そのまま契約」",
      "06:11 ★3日特典の鉄板トーク「3日以内に決めてくれたら特典2つ：動画3ヶ月→無制限視聴（40万円相当）＋申請手数料6万円→0円。3人なら18-20万違う」（即決誘導）",
      "08:00 ◆助成金不安への定型対応「去年500件全通過、3-6ヶ月後降りる。追加質問は『事務局に対応します』と控える」（クローザー必暗記の定型回答）",
      "10:07 ★最強クロージングトーク「明日、スマホ持ってない人と仕事できますか？来年再来年でAI使ってる企業と使ってない企業で10倍100倍生産性差、置いていかれますよ」",
      "11:03 ◆年齢不安への切り返し「50-60歳でも全然定着、シェル形式の聞き方なので経験豊富な方の方が習慣化したらできる」（年配層への定型回答）",
      "12:00 ◆雇用保険ヒアリングの必須質問「『正しく雇用保険入ってますか』『何人ですか』を必ず聞く、社長・役員入ってない場合は従業員1-2名で対応」（ヒアリング漏れ防止）",
      "14:14 ★入金確認までの背中押し「『どうですか？ちゃんといけてますか？』とガンガンアシストしないと、せっかく受注したのにポシャって報酬発生しない」（クローザー最後の仕事）",
      "15:00 ★差別化の決め台詞「中小企業×実務で結果出す領域では2番1自信、2日合宿＋3ヶ月毎週プッシュサポート、クラウドワーカー月1000名の採用力で個別対応、定着率100%」",
      "19:00 ★競合システムを一蹴「他のシステムは無駄です、使わないでくださいと言い切ってOK。月1万円のシステム＝月3000円AIで全部できる、300万システムも月3000円AIで代替」",
      "20:01 ◆指数関数的価値「中小企業は1人が万能でないと。AIをきちんと使える人を育てると、付加価値が高い業務の効率が指数関数的に上がる」（長期ビジョンの提示）",
    ],
